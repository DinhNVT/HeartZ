...
sealed class NavMain(var route: String, var icon: Int?, var title: String, var titleHeader: String) {
    object Home: NavMain("home", R.drawable.home, "Home", "Heart Z")
    ...
    object ChangeProfile: NavMain("change_profile", null, "", "")
    object ChangePassword: NavMain("change_password", null, "", "")
}
